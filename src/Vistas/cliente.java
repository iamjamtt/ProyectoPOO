...
public class cliente extends javax.swing.JInternalFrame {
    ...
    Entidad.NroCta cta = new NroCta();
    Entidad.Cliente cli = new Cliente();
    Modelo.ClienteDAO cdao = new ClienteDAO();
    
    public static int idcliente; public static String dni, nom;
    ...
    void listar(){
        try {
            m = cdao.mostrar(txtBuscar.getText());
            tabla.setModel(m);
        } catch (Exception e) {
    ...
    void agregar(){
        String valdni = cdao.consultarDni(txtDni.getText());
        if(txtNombre.getText().equals("") || txtApellido.getText().equals("") || txtTelefono.getText().equals("") || txtDni.getText().equals("") || txtDireccion.getText().equals("")){
            ...
            txtNombre.requestFocus();
        }else if(txtDni.getText().equals(valdni)){
            ...
            idcliente = cdao.consultarIDIngresado(dni);
            System.out.println("id ingresado cliente " + idcliente);
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Generar Cta");
        ...
        jMenuItem2.setText("Seleccionar Datos");
