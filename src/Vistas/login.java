...
public class login extends javax.swing.JFrame {
    ...
    void placeholders(){
        TextPrompt a1 = new TextPrompt("Emplado Username*", txtUsername);
    ...
    void validad(){
        ...
        if(txtUsername.getText().equals("") || txtPass.getText().equals("")){
            ...
            if(eu.getUsername() != null && eu.getPass() != null){
                idu = eu.getIdUser();
                System.out.println("id user " + idu);
                username = eu.getUsername();
                name = eu.getNombre();
                ape = eu.getApellido();
    ...
    private void initComponents() {
        ...
        txtUsername.setFont(new java.awt.Font("Open Sans", 0, 15)); // NOI18N
        ...
        txtPass.setFont(new java.awt.Font("Open Sans", 0, 15)); // NOI18N
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 310, 453));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/loginfondoo (2).jpg"))); // NOI18N
